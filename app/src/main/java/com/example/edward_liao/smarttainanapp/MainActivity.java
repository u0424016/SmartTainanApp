...
public class MainActivity extends AppCompatActivity {
    ...
    private Button button_children, button_parents;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_children = (Button) findViewById(R.id.button_children);
        button_parents = (Button) findViewById(R.id.button_parents);
